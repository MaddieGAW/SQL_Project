...
# Join to retrieve all of the countries with country fatalities data
...
# Breakdown of actor total
SELECT actor_name, COUNT(*) as total_by_actor
FROM incidents
GROUP BY actor_name
ORDER BY total_by_actor DESC;

# Breakdown of actor total
SELECT actor_type, COUNT(*) as total_by_actor_type
FROM incidents
GROUP BY actor_type
ORDER BY total_by_actor_type DESC;